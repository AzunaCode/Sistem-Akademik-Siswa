        ...
        <div class="col-sm-12 p-0">
            <div class="main-header">
                ...
                <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item"><a href="index.php?guru=mapeldiampu">Mapel</a>
                    </li>
                </ol>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    while ($mapel=$data->fetch_assoc()) {
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                            <a href="index.php?guru=<?= $mapel['id_ajar'] ?>" class="btn btn-success btn-sm" ><i class="icon-refresh"></i> INPUT NILAI</a>
                                        </td>
                                    </tr>
                                    <?php 
                                    $no++;
