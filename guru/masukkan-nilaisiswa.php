                                    ...
                                    <tbody>
                                        ...
                                        while ($nilai=$data->fetch_assoc()) {
                                         ...
                                         <tr>
                                             ...
                                             <td ><input style="width:50%" type="float" name="hadir[]" class="md-form-control"  value="<?= $nilai['kehadiran']?>"></td>
                                             <td ><input style="width:50%" type="float" name="uts[]" class="md-form-control"  value="<?= $nilai['uts']?>"></td>
                                             <td ><input style="width:50%" type="float" name="uas[]" class="md-form-control"  value="<?= $nilai['uas']?>"></td>
                                             <td ><input style="width:50%" type="float" name="akhir[]" class="md-form-control" value="<?= $nilai['nilai_akhir']?>"></td>
